...
app.controller('PrincipalCtrl',function($scope,$http){
    ...
    $scope.ejemplo=[
        ...
        $scope.equipo = [];
        $scope.flags = [];
        for (var i=0; i < $scope.ejemplo.length; i++ ){
            $scope.equipo.push($scope.ejemplo[i].home_team_country);
            $scope.equipo.push($scope.ejemplo[i].away_team_country);

            $scope.flags.push($scope.ejemplo[i].home_team.code);
            $scope.flags.push($scope.ejemplo[i].away_team.code);
        };
    });
